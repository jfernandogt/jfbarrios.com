		...
		$('.contact-form').submit(function(e){
			...
			if( $form.valid() ){
				...
				$.ajax({
					...
					data: dataString,
					success: function() {
						$submit.before('<div class="message message-success">Tu mensaje ha sido enviado correctamente!</div>');
					},
					error: function() {
						$submit.before('<div class="message message-error">Tu mensaje no pudo ser enviado, intenta después.</div>');
					},
					complete: function() {
